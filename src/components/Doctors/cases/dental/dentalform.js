...
function DentalForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post('http://localhost:5000/dentalRegistation', {
        ...formData,
        vaccinationHistory,
      });
    ...
    <div className='empid144consultation-form'>
      ...
      <form className='empid144form' onSubmit={handleSubmit}>
        ...
        <div className='empid144submitb'>
          <button className='empid144subbuton' type="submit">Save</button>
   <Link to='/dentalform1'> <button className='empid144nxtbuton' type="button">Next</button></Link>
        </div>
      </form>
    </div>
    </div>
