...
const AddBillLab = () => {
  ...
  useEffect(() => {
    async function fetchTestData() {
      try {
        const response = await axios.get("http://localhost:5000/api/lab-services"); // Replace with your API endpoint
  ...
  const handlePay300 = async () => {
    const billData = {
      ...
      consultationFee,
      totalBalance: consultationFee + totalLabServicesFee,
      paymentMode,
      email,
      labreferal,
    };
    ...
    try {
      ...
      console.log("Bill data sent successfully:", response.data);
    } catch (error) {
        ...
        <div className="data-table-06">
          ...
          <div className="bill-form-06">
            ...
            <div className="form-row-06">
              ...
              <span>₹{consultationFee + totalLabServicesFee}</span>
            </div>
            ...
            <div className="button-container-06">
              <button onClick={handlePay300}>
                Pay Rs {consultationFee + totalLabServicesFee}
              </button>
            </div>
            <div className="button-container-06">
